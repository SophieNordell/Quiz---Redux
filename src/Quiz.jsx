...
function Quiz() {
  ...
  return (
    <div className="flex flex-col space-y-4 w-fit p-10  ">
      ...
      <button
        className="bg-purple-300 text-green-50 rounded text-xl p-2 mt-4 hover:bg-purple-500 "
        onClick={() => answerQuestion(1)}
      >
        {currentQuestionn.alt1}
      </button>
      <button
        className="bg-purple-300 text-green-50 rounded text-xl p-2  hover:bg-purple-500  "
